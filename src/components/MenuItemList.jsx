  ...
  return (
    ...
    >
      ...
      <div className="w-32 text-center">
        ...
        <div>
          {itemCount >= 1 ? (
            <div className="font-bold px-1 text-lg flex justify-evenly text-green-600 border-2 shadow-sm rounded-xl mb-5 w-32">
              <button
            ...
            <button
              className="font-bold text-lg text-green-600 shadow-sm rounded-xl bg-white border-2 mb-5 border-slate-300 w-32"
